...
public class EditStaffMappingPage extends BasePage {
    ...
    private By resources=
            ...
            private By rowclick = By.xpath("//tr[td//mat-checkbox][1]/td[2]");

    private By checkBox= By.xpath("(//div[@class='checkbox']//label[contains(@class,'mat-checkbox-layout')])[2]");
