...
public class ProductsPage extends BasePage {
    ...
    private By measure =
            By.xpath("//mat-select[@formcontrolname='Mesure']");

    private By rdesc =
            By.xpath("//input[contains(@placeholder,'Product Description')]");

    private By pcategory =
            By.xpath("//span[text()='Product Category']");
    ...
    private By retailPrice =
            By.xpath("//input[contains(@placeholder,'Retail Price')]");
    ...
    public void createProducts() {
        ...
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(retailPrice))
