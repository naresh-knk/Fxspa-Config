...
public class StaffMappingPage extends BasePage {
    ...
    private By selectStaffName =
            By.xpath("//span[text()='Staff Name']");

    private By ok =
            By.xpath("//button[text()=' OK ']");

    private By checkBox =
            By.xpath("(//div[@class='checkbox']//label[contains(@class,'mat-checkbox-layout')])[1]");
    ...
    public void createStaffMapping() {
        ...
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(ok))
                .click();
